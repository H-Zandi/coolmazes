...
public class MazesDBAdapter {
	private static final String DATABASE_NAME = "coolmazes.db";
	...
	private MazesDBOpenHelper mDBHelper;

	public MazesDBAdapter(Context context) {
		mDBHelper = new MazesDBOpenHelper(context, DATABASE_NAME, null,
				DATABASE_VERSION);
	}

	public MazesDBAdapter open() throws SQLException {
	...
	public void updateMaze(int id, int solution_steps) {
		...
		mDB.update(DATABASE_TABLE, values, KEY_ID + " = ? AND ("
	...
	private static class MazesDBOpenHelper extends SQLiteOpenHelper {
		private static final String DATABASE_CREATE = "create table "
				+ DATABASE_TABLE + " (" + KEY_ID
				+ " integer primary key autoincrement, " + KEY_NAME
				+ " text not null, " + KEY_SOLUTION_STEPS + " integer" + ");";

		public MazesDBOpenHelper(Context context, String name,
		...
		public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
			// FIXME(leczbalazs) implement data migration instead of the
			// DROP+CREATE
